...
| Guide | Use when |
| --- | --- |
| [docs/authoring-app.md](docs/authoring-app.md) | Planned engineer authoring app: metric-first plans, MATLAB-flavored formulas, run-export goldens, pack/ship, TUI compat |
