...
public sealed class SmokeNavigationTests
{
    ...
    public void MainWindow_opens_with_nav_and_home()
    {
        ...
        Assert.DoesNotContain(main.NavigationItems, i => i.Id == "Inspect");
        Assert.Contains(main.NavigationItems, i => i.Id == "Results");
        Assert.DoesNotContain(main.NavigationItems, i => i.Id == "ReportPreview");
        Assert.DoesNotContain(main.NavigationItems, i => i.Id == "Instruments");
