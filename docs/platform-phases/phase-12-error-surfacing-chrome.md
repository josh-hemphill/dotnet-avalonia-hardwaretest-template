...
- Full Accessibility / AutomationProperties / kiosk compositor ([deferred-appliance-kiosk.md](../deferred/deferred-appliance-kiosk.md)); operator hit-target floor shipped in [Phase 18](phase-18-operator-touch-density.md) after [Phase 17](phase-17-shell-notification-strip.md)
