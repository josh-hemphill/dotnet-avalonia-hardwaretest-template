...
% write TfModelJson: numerator, denominator, tsSeconds, inputChannelKey,
% outputChannelKey, method='filter', timeBase='elapsedMs', initialConditions='zero'
